...
```bash
git remote add encore encore://gaming-top-up-platform-cia2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/gaming-top-up-platform-cia2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/gaming-top-up-platform-cia2/settings/integrations/github)
