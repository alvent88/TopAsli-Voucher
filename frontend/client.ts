 ...
 */
import type { auth as auth_auth } from "~backend/auth/custom_auth";
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        public async setDefaultPassword(): Promise<void> {
            await this.baseClient.callTypedAPI(`/admin/set-default-password`, {method: "POST", body: undefined})
        }
...
import {
    resetPasswordPhone as api_auth_forgot_password_phone_resetPasswordPhone,
    sendForgotPasswordPhoneOTP as api_auth_forgot_password_phone_sendForgotPasswordPhoneOTP,
    verifyForgotPasswordPhoneOTP as api_auth_forgot_password_phone_verifyForgotPasswordPhoneOTP
} from "~backend/auth/forgot_password_phone";
...
import { loginPhoneV2 as api_auth_login_phone_v2_loginPhoneV2 } from "~backend/auth/login_phone_v2";
...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async loginPhoneV2(params: RequestType<typeof api_auth_login_phone_v2_loginPhoneV2>): Promise<ResponseType<typeof api_auth_login_phone_v2_loginPhoneV2>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/login-phone-v2`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_login_phone_v2_loginPhoneV2>
        }
        ...
        public async resetPasswordPhone(params: RequestType<typeof api_auth_forgot_password_phone_resetPasswordPhone>): Promise<ResponseType<typeof api_auth_forgot_password_phone_resetPasswordPhone>> {
            // Now make the actual call to the API
        ...
        public async verifyAndRegister(params: RequestType<typeof api_auth_register_phone_v2_verifyAndRegister>): Promise<ResponseType<typeof api_auth_register_phone_v2_verifyAndRegister>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/register/verify-and-create`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_register_phone_v2_verifyAndRegister>
        }

        public async verifyForgotPasswordPhoneOTP(params: RequestType<typeof api_auth_forgot_password_phone_verifyForgotPasswordPhoneOTP>): Promise<ResponseType<typeof api_auth_forgot_password_phone_verifyForgotPasswordPhoneOTP>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/forgot-password-phone/verify-otp`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_forgot_password_phone_verifyForgotPasswordPhoneOTP>
        }
    }
}
...
export namespace balance {
    ...
    export class ServiceClient {
        ...
        public async getUserBalance(params: RequestType<typeof api_balance_get_balance_getUserBalance>): Promise<ResponseType<typeof api_balance_get_balance_getUserBalance>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/balance/get`, {query, method: "GET", body: undefined})
