      ...
      <div className="container mx-auto px-4 py-16 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-slate-900 mb-2">Konfirmasi Pembelian</h1>
            <p className="text-slate-600">Pastikan detail pembelian Anda sudah benar</p>
          </div>

          <Card className="bg-white border-slate-200 shadow-lg mb-6">
            <CardHeader>
              <CardTitle className="text-slate-900 text-lg">Detail Transaksi</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-slate-900">{packageName}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">User ID</span>
                <span className="text-slate-900 font-mono text-xs">{userId}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-600">Server ID</span>
                <span className="text-slate-900 font-mono text-xs">{gameId}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="border-t border-slate-200 pt-2 mt-2 space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-blue-600 font-bold">{formatCurrency(price)}</span>
                </div>
                {!balanceLoading && isSufficientBalance && (
                  <div className="flex justify-between pt-1">
                    <span className="text-slate-600 text-xs">Sisa Saldo</span>
              ...
              <CardContent className="pt-6">
                <div className="text-center space-y-3">
                  ...
                  <div className="bg-red-950/50 rounded-lg p-3 mt-4">
                    <div className="text-xs text-slate-600 mb-1">Kekurangan</div>
